<aside class="main-sidebar elevation-4 {{ config('admin.adminlte.theme.sidebar') ?: 'sidebar-dark-primary' }}">
    <a href="{{ admin_base_path('/') }}" class="brand-link {{ config('admin.adminlte.theme.logo') ?: '' }}">
